      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col gap-6 pr-6 lg:border-r lg:border-border">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <span className="block text-xs mb-1 text-muted-foreground">Active Customers</span>
              <span className="block text-lg font-medium text-card-foreground">12,847</span>
            </div>
            <div>
            ...
            <div>
              <span className="block text-xs mb-1 text-muted-foreground">Payments Processed</span>
              <span className="block text-lg font-medium text-card-foreground">45,231</span>
            </div>
            <div>
              <span className="block text-xs mb-1 text-muted-foreground">Avg Order Value</span>
              <span className="block text-lg font-medium text-card-foreground">$97</span>
            </div>
          </div>
        </div>
