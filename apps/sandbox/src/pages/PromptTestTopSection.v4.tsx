...
const REVENUE_CATEGORIES = [
  { id: "product", label: "Product Sales", value: "$198,000", color: "bg-blue-500" },
  { id: "subscription", label: "Subscriptions", value: "$142,500", color: "bg-emerald-500" },
  { id: "services", label: "Services", value: "$72,000", color: "bg-amber-500" },
  { id: "licensing", label: "Licensing", value: "$37,500", color: "bg-violet-500" },
] as const;
