...
function MiniUIFork() {
  return (
    ...
    >
      <div
        className="bg-[#262626] dark:bg-[#262626] border border-[#2f2f2f] rounded-xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] overflow-hidden"
        style={{
          boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.25)",
        }}
      >
        <button
          className="flex items-center gap-1.5 px-2 py-1 text-xs text-white cursor-pointer bg-transparent border-none whitespace-nowrap hover:bg-[rgba(255,255,255,0.1)] pointer-events-auto"
          style={{
            height: "24px",
          }}
        >
