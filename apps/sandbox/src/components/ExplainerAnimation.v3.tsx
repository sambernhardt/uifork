...
// Home Content Component - Skeleton Placeholder
      ...
      >
        {!isOpen ? (
          ...
          >
            ...
            {/* Component Name */}
            <span className="font-medium text-white whitespace-nowrap text-xs">HomeContent</span>
            {/* Version */}
          ...
          <div className="min-w-[200px] p-1 flex flex-col">
            ...
            <div className="flex items-center justify-between px-3 py-2">
              <button
                ...
                style={{ height: "32px" }}
              >
                <span className="font-medium text-white">HomeContent</span>
                <svg
