...
function FakeCursor({ containerRef }: { containerRef: React.RefObject<HTMLDivElement> }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* White outline for macOS cursor effect */}
        <path
          d="M0.5 0.5L0.5 16.5L7 10.5L10.5 14L15 9L0.5 0.5Z"
          fill="white"
          stroke="white"
          strokeWidth="1"
          strokeLinejoin="round"
        ...
        {/* Black arrow fill */}
        <path
          d="M1 1L1 16L7.5 10L10.5 13.5L14.5 8.5L1 1Z"
          fill="black"
        />
      </svg>
    </div>
