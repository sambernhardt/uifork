        ...
        <div className="w-32 bg-muted border-r border-border flex flex-col">
          <div className="flex-1 overflow-auto p-1">
            <div className="space-y-0.5">
              ...
              <div className="pl-6 pr-1.5 py-0.5 text-[10px] text-muted-foreground">DashboardContent.v1.tsx</div>
              <div className="pl-6 pr-1.5 py-0.5 text-[10px] text-muted-foreground">DashboardContent.v2.tsx</div>
      ...
      >
        {!isOpen ? (
          ...
          >
            ...
            {/* Component Name */}
            <span className="font-medium text-white whitespace-nowrap text-xs">DashboardContent</span>
            {/* Version */}
          ...
          <div className="min-w-[200px] p-1 flex flex-col">
            {/* Component Selector */}
            <div className="flex items-center justify-between px-3 py-2">
              <button
                className="flex items-center gap-2 text-sm text-white bg-transparent border-none cursor-pointer rounded-lg hover:bg-[rgba(255,255,255,0.1)] flex-1 justify-between"
                style={{ height: "32px" }}
              >
                <span className="font-medium text-white">DashboardContent</span>
                <svg
            ...
            {/* Divider */}
            <div className="h-px bg-[#2f2f2f] my-1"></div>
                ...
                .map((versionInfo) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center gap-2 px-3 py-2 text-sm text-white cursor-pointer rounded-lg hover:bg-[rgba(255,255,255,0.1)] relative"
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-1 min-w-0">
                        <span className="text-white text-sm">{formattedVersion}</span>
                      </div>
                    </div>
                  );
                })}
