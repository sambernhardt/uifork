  ...
  return (
    <div className="w-full h-full bg-card rounded-lg border border-border overflow-hidden shadow-lg flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-44 bg-muted border-r border-border flex flex-col">
          <div className="flex-1 overflow-auto p-1">
            <div className="space-y-0.5">
              ...
              <div className="pl-6 pr-1.5 py-0.5 text-[10px] text-muted-foreground">DashboardContent.versions.ts</div>
            </div>
          </div>
        </div>
